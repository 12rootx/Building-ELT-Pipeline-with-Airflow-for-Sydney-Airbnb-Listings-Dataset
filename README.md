...
### Project Objective
This project aims to build an end-to-end Extraction, Loading, and Transformation (ELT) pipeline for the Sydney Airbnb listings dataset. Using **Airflow from GCP** for orchestration and scheduling tasks, **dbt (Data Build Tool)** will handle data transformations, creating a **Medallion architecture** in a GCP **PostgreSQL-based data warehouse**. The project also includes business analysis, generating insights into Sydney’s Airbnb market.
